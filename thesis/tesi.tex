...
\begin{figure}[h]
  	...
  	\centering
  	\includegraphics[width=0.5\textwidth]{figures/epstube.pdf}
  	\qquad
  	\includegraphics[width=0.5\textwidth]{figures/epsloss.pdf}
  	\end{adjustwidth}
...
\begin{figure}[hp]
	...
	\begin{adjustwidth}{-1.5in}{-1in}
  	...
  	\label{jointplotsfig}
  	\begin{tabular}{cc}
  		\includegraphics[width=0.5\textwidth]{figures/jointplot1.pdf} & 
  		\includegraphics[width=0.5\textwidth]{figures/jointplot2.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot3.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot7.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot8.pdf} & 
...
\begin{figure}[hp]
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{figures/jointplot10.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot11.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot12.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot13.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot14.pdf} & 
  		\includegraphics[width=0.5\textwidth]{figures/jointplot15.pdf} \\
  	\end{tabular}
  	\end{adjustwidth}
\end{figure}
\begin{figure}[hp]
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{figures/jointplot16.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot17.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot18.pdf}
  	\end{tabular}
  	\end{adjustwidth}
\end{figure}
...
\begin{figure}[hp]
  \centering
  	\includegraphics[width=0.7\textwidth]{figures/thertovisjoint.pdf}
  \caption{Joint plot of \textit{Therapy to visit} feature and \textit{Survival time}.}
  \label{thertovisjfig}
  \vspace{0.7cm}
  \centering
  	\includegraphics[width=0.8\textwidth]{figures/thertoviscorr.pdf}
...
\begin{figure}[hp]
  \centering
  	\includegraphics[width=0.8\textwidth]{figures/featsubset1.pdf}
  ...
  \vspace{0.7cm}
  \centering
  	\includegraphics[width=0.8\textwidth]{figures/featsubset2.pdf}
...
\begin{figure}[h]
	\begin{adjustwidth}{-1.5in}{-1in}
  	...
  	\begin{tabular}{ccc}
  		& (a) & (b) \\
  		\fbox{$\delta_i = 0$} &
  		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss2.pdf}} & 
  		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss4.pdf}} \\
  		\fbox{$\delta_i = 1$} &
		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss1.pdf}} &
		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss3.pdf}} \\
  	\end{tabular}
  	\end{adjustwidth}
...
\begin{figure}[hp]
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
  		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp1.pdf} & 
  		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp4.pdf} \\
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp2.pdf} &
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp5.pdf} \\
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp3.pdf} &
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp6.pdf} \\
  	\end{tabular}
  	\end{adjustwidth}
...
Removing IP Gravity, FE \%, EDVI, ESVI, Allo sist. Normal NA, max censoring, StandardScaler & -3.2217 & 6.0365 & 0.5750 & 0.0842 \\ \hline
Removing IP Gravity, FS \%, ESVI, Allo diast e Allo sist. Normal NA, max censoring, StandardScaler & -1.4231 & 1.7689 & 0.5780 & 0.1549 \\ \hline
\end{tabular}
