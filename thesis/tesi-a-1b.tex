...
\begin{figure}[h]
  	...
  	\centering
  	\includegraphics[width=0.5\textwidth]{figures/epstube-alt.pdf}
  	\qquad
  	\includegraphics[width=0.5\textwidth]{figures/epsloss-alt.pdf}
  	\end{adjustwidth}
...
\begin{figure}[h]
  \centering
  	\includegraphics[width=1.0\textwidth]{figures/heatmap-alt.pdf}
...
\begin{figure}[hp]
	...
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
  		\includegraphics[width=0.5\textwidth]{figures/jointplot1-alt.pdf} & 
  		\includegraphics[width=0.5\textwidth]{figures/jointplot2-alt.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot3-alt.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot7-alt.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot8-alt.pdf} & 
  		\includegraphics[width=0.5\textwidth]{figures/jointplot9-alt.pdf} \\
  	\end{tabular}
  	\end{adjustwidth}
\end{figure}
\begin{figure}[hp]
	...
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{figures/jointplot10-alt.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot11-alt.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot12-alt.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot13-alt.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot14-alt.pdf} & 
  		\includegraphics[width=0.5\textwidth]{figures/jointplot15-alt.pdf} \\
  	\end{tabular}
  	\end{adjustwidth}
\end{figure}
\begin{figure}[hp]
	...
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{figures/jointplot16-alt.pdf} &
		\includegraphics[width=0.5\textwidth]{figures/jointplot17-alt.pdf} \\
		\includegraphics[width=0.5\textwidth]{figures/jointplot18-alt.pdf}
  	\end{tabular}
  	\end{adjustwidth}
\end{figure}
\end{subfigures}
...
\begin{figure}[hp]
  \centering
  \vspace*{-1cm}
  	\includegraphics[width=0.7\textwidth]{figures/thertovisjoint-alt.pdf}
  \caption{Joint plot of \textit{Therapy to visit} feature and \textit{Survival time}.}
  \label{thertovisjfig}
  \vspace{0.5cm}
  \centering
  	\includegraphics[width=0.8\textwidth]{figures/thertoviscorr-alt.pdf}
  \vspace{-0.2cm}
...
\begin{figure}[hp]
  \centering
  \vspace*{-0.8cm}
  	\includegraphics[width=0.8\textwidth]{figures/featsubset1-alt.pdf}
  \vspace{-0.2cm}
  ...
  \vspace{0.1cm}
  \centering
  	\includegraphics[width=0.8\textwidth]{figures/featsubset2-alt.pdf}
  \vspace{-0.2cm}
...
\begin{figure}[h]
	\begin{adjustwidth}{-1.5in}{-1in}
  	...
  	\begin{tabular}{ccc}
  		& (a) & (b) \\
  		\fbox{$\delta_i = 0$} &
  		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss2-alt.pdf}} & 
  		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss4-alt.pdf}} \\
  		\fbox{$\delta_i = 1$} &
		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss1-alt.pdf}} &
		\raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{figures/altloss3-alt.pdf}} \\
  	\end{tabular}
  	\end{adjustwidth}
...
\begin{figure}[hp]
	...
	\begin{adjustwidth}{-1.5in}{-1in}
  	\centering
  	\begin{tabular}{cc}
  		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp1-alt.pdf} & 
  		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp4-alt.pdf} \\
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp2-alt.pdf} &
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp5-alt.pdf} \\
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp3-alt.pdf} &
		\includegraphics[width=0.58\textwidth]{figures/custsvrcomp6-alt.pdf} \\
  	\end{tabular}
  	\end{adjustwidth}
  	\vspace*{-0.2cm}
...
\end{tabular}
\captionof{table}{Experiment results on standard SVR model with repeated holdout, maximizing $R^2$ score.}\label{resultstab:1}
\end{center} 
...
\end{tabular}
\captionof{table}{Experiment results on alternative SVR models with repeated holdout, maximizing c-index score.}\label{resultstab:2}
\end{center} 
